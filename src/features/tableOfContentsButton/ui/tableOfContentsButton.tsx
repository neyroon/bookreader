...
import { StyledTableOfContentsIcon, Title, TitleList } from './tableOfContentsButton.styles';
import { Button } from '@/shared/ui/button';
import { Modal } from '@/shared/ui/modal';
import { useState } from 'react';
import { setCurrentSection } from '@/entities/pageBuilder/model';
...
export const TableOfContentsButton = () => {
  ...
  const handleTitleClick = (index: number) => dispatch(setCurrentSection(index));
        ...
        <Modal title='Содержание' onClose={handleClose}>
          <TitleList>
            {sections.map((section, i) => (
              <Title onClick={() => handleTitleClick(i)} $active={currentSection === i} key={section.id}>
