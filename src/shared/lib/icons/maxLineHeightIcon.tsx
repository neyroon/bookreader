...
export const MaxLineHeightIcon = ({ className }: IconProps) => (
  <svg width='40' height='15' viewBox='0 0 40 15' fill='none' className={className} xmlns='http://www.w3.org/2000/svg'>
